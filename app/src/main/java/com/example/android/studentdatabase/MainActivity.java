package com.example.android.studentdatabase;
...
public class MainActivity extends AppCompatActivity {
    ...
    EditText etName,etEmail,etHcp,etID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etHcp = (EditText) findViewById(R.id.etNewHcp);
    ...
    public void AddData() {
        btnAddData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String handicap = etHcp.getText().toString();

                boolean insertData = peopleDB.addData(name,email, handicap);
        ...
        btnViewData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                while (data.moveToNext()) {
                    ...
                    buffer.append("Handicap: " + data.getString(3) + "\n");

                    //Toast.makeText(MainActivity.this, "datacount " + data.getCount(), Toast.LENGTH_SHORT).show();
            ...
            public void onClick(View v) {
                ...
                if (temp > 0) {
                    boolean update = peopleDB.updateData(etID.getText().toString(), etName.getText().toString(),
                            etEmail.getText().toString(), etHcp.getText().toString());
                    if (update == true) {
